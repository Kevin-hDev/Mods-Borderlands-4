"""Vehicle Driving opens once from its own SDK menu and keeps native options as fallback."""
...
from vehicle_driving import panel_entry, panel_open, control_window
...
print("OK | Vehicle Driving menu opens once, keeps SDK fallback and returns to mod list")
