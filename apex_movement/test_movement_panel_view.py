...
from apex_movement import panel_assets, panel_fonts, panel_model, panel_theme as theme, panel_view  # noqa: E402
...
assert len(widgets["pages"].children) == len(model.pages) == 10
assert widgets["focus"] is widgets["nav:movement"]
...
print("OK | full Movement window builds ten pages and a scrolling sidebar")
