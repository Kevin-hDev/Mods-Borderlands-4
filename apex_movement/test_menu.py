...
check("slides hold their switch, the direction switch, speed, distance, downhill pull and top speed, and no steering",
      menu.slides.children == [settings.slides, settings.momentum_slides, settings.slide_speed,
                               settings.slide_distance, settings.slide_downhill_pull, settings.slide_max_speed])
