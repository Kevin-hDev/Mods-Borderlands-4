"""A shortcut's two fields on the Options page: the bound key, then the button that captures a new one."""

import unrealsdk
from mods_base import KeybindOption

from . import panel_buttons as b, panel_i18n as i18n, panel_text as tx, panel_theme as t, panel_widgets as w
