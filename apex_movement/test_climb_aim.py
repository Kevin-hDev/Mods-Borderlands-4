"""Tests aiming a climb: the angles to a wall, how far the stick leans along it, and the direction that comes out of
that. The longest a climb can last is the rules' (test_climb_rules.py)."""
